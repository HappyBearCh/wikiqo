 ...
 * all ~7M articles is neither feasible at request time nor desirable. Each
 * day's top-1000 list is immutable history, so it's cached for a year;
 * namespace pages (Special:, File:, etc.) and the main page are dropped so
 * only real articles remain.
 *
